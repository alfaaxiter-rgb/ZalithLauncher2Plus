 ...
 * ============================================================
 *
 * Bagian-bagian di bawah tetap dipertahankan supaya fungsi
 * launcher lama yang masih dipakai oleh fork lain tidak hilang.
 */
        ...
        if (BuildConfig.DEBUG) {
            BackgroundCard(
                ...
                Column(
                    ...
                    Text(
                        text = stringResource(
                            R.string.launcher_version_debug_warning,
                    ...
                    Text(
                        modifier = Modifier
                            ...
                            .align(Alignment.End),
                        text = stringResource(
                            R.string.launcher_version_debug_warning_cant_close
                        ),
            ...
            is HomePageState.Loading -> {
                Box(
                    ...
                    Column(
                        ...
                        Text(
                            text = stringResource(
                                R.string.settings_launcher_home_page_loading
                            ),
...
private const val CHANGELOGS_URL =
    "https://raw.githubusercontent.com/Star1xr/ZalithLauncher2Plus/refs/heads/main/CHANGELOGS_UPDATE.md"

private const val CHANGELOGS_UPDATE_TR =
    "https://raw.githubusercontent.com/Star1xr/ZalithLauncher2Plus/refs/heads/main/CHANGELOGS_UPDATE_TR.md"
...
private fun StatsGrid(
    ...
    val versionNames = remember(versions) {
        versions.map {
            it.getVersionName()
        }
    }
...
private fun WeeklyPlayTimeChart(
    ...
    val weekData = remember(versionNames) {
        val dates = PlayTimeRepository
            .lastNDays(7)
            .reversed()

        dates.map { date ->
            date to PlayTimeRepository.getDailyTotalPlayTime(
                date,
                versionNames
            )
        }
    ...
    val maxMs = remember(weekData) {
        weekData.maxOfOrNull {
            it.second
        } ?: 1L
    }
    ...
    BackgroundCard(
        ...
        Column(
            ...
            Text(
                text = stringResource(
                    R.string.stats_play_time_graph
                ),
                style = MaterialTheme.typography.labelSmall,
                modifier = Modifier
                    .fillMaxWidth()
...
private fun DailyPlayTimeCard(
    ...
    val todayMs = remember(versionNames) {
        PlayTimeRepository.getDailyTotalPlayTime(
            PlayTimeRepository.today(),
            versionNames
        )
    }
...
private fun LastLogCard(
    ...
    val currentVersion by VersionsManager.currentVersion
        .collectAsStateWithLifecycle()

    val logFile = remember(currentVersion) {
        currentVersion?.let {
            VersionsManager.getLatestLog(it)
        }
    }
...
private fun RightMenuContent(
    ...
    val account by AccountsManager.currentAccountFlow
        .collectAsStateWithLifecycle()

    val version by VersionsManager.currentVersion
        .collectAsStateWithLifecycle()

    val isRefreshing by VersionsManager.isRefreshing
        .collectAsStateWithLifecycle()
    ...
    ConstraintLayout(
        ...
        var versionManagerRow by remember {
        ...
        Box(
                    ...
                    ?.let {
                        ...
                        IconButton(
                            ...
                            Icon(
                                ...
                                contentDescription = stringResource(
                                    R.string.versions_manage_settings
                                )
                            )
                        }
                    }
            ...
            val menuAnchorBounds =
                menuAnchor?.boundsInParent()

            val menuAnchorX =
                menuAnchorBounds?.left ?: 0f

            val menuAnchorHeight =
                menuAnchorBounds?.height ?: 0f
            ...
            DropdownMenu(
                ...
                offset = DpOffset(
                    ...
                    y = with(LocalDensity.current) {
                        (-menuAnchorHeight).toDp()
                    } - 8.dp
                ),
                shape = MaterialTheme.shapes.extraLarge
            ) {

                val versions by VersionsManager.versions
                    .collectAsStateWithLifecycle()
        ...
        if (isRefreshing) {
            ...
            if (version == null) {
                ...
                Text(
                    ...
                    text = stringResource(
                        R.string.versions_manage_no_versions
                    ),
                    style = MaterialTheme.typography.labelMedium,
                    maxLines = 1
                )
            ...
            Column(
                ...
                when {
                    ...
                    isLoading -> {
                        ...
                        Text(
                            text = stringResource(
                                R.string.stats_changelog_loading
                            ),
                            style = MaterialTheme.typography.labelSmall,
                            modifier = Modifier.alpha(0.6f)
                        )
        ...
        Dialog(
            ...
            Surface(
                ...
                Column(
                    ...
                    MarkdownView(
                        content =
                            "# ${stringResource(R.string.stats_changelog)}\n\n${content!!}",
                        modifier = Modifier
                            .weight(1f)
                            .verticalScroll(
                                rememberScrollState()
...
private fun Modifier.bottomFade(
    edgeHeight: androidx.compose.ui.unit.Dp
): Modifier = this
    .graphicsLayer {
        clip = true
        compositingStrategy =
